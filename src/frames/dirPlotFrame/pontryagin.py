    ...
    def solver(self):
        match self.typeAlg:
            case self.TASKS.naiskDvi.value:
                return PontryaginCompute(self.dfs, self.fs, self.bs, alpha1=1,alpha2=0,args=self.psi0, **self.kwargs)
...
class PlotAgent:
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        if isinstance(xs[0], np.ndarray):
            ...
            self.setPlot(self.axs[-1][-1], t, u, u"Управляемая сила", ('t', 'u'))
        else:
...
class PontryaginCompute:
    def __init__(self, dfs, fs, bs, alpha1=0, alpha2=0, args=(), **kwargs) -> None:
